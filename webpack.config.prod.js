 ...
 * npm install broccoli-cssnano
 * @type {[type]}
 */
// var OptimizeCssAssetsPlugin = require('optimize-css-assets-webpack-plugin')

//当前相对路径
var relatePath = '../../../public/txq2/mobile'
//输出路径
var outputPath = '/public/txq2/mobile'
...
module.exports = {
	...
	output: {
		//发布的目录
		path: path.join(__dirname, relatePath + '/dist'),
		//[name]变量指向 entry.*
		filename: '[name].js',
		//静态资源路径修改
		publicPath: outputPath + '/dist/'
	},
	//其他功能模块的配置
	module: {
		rules: [
    ...
    new HtmlWebpackPlugin({
      ...
      template: path.join(__dirname, './src/') + 'index.template.shtml',
      // 设置文件名称以及文件生成的位置，这里如果是相对路径的话，则 ./ === output.path
      filename: path.join(__dirname, './') + 'index.shtml',
      showErrors: true,
      excludeChunks: ['index']
    }),
    // 启用js,css代码压缩
    ...
    // extensions: ['', '.js', '.json', '.less'],
      ...
      c_store: path.resolve(__dirname, './src/store/common'),
